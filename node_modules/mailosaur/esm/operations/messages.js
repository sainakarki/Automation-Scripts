    ...
    async get(serverId, criteria, options = {}) {
        ...
        try {
            ...
            if (!result.items || result.items.length === 0) {
                throw new MailosaurError('No messages found matching criteria.', 'no_messages_found');
            }
